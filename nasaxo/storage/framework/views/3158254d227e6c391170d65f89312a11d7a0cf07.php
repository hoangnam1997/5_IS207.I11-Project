        ...
        <div id="fSetTime" class="frmMenu">
            ...
            <div style="display:inline-block;">
                <div style="display:inline-block;position:relative;bottom:4px;left:4px;">
                    ...
                    <div>
                        <button type="submit" id="btnStatistics" class="btn btn-success" style="width:auto;height:auto;font-size:13px;display:inline-block;" onclick="getStatistic('<?php echo url('admin/statictis/nonsellView'); ?>')">Thống kê</button>

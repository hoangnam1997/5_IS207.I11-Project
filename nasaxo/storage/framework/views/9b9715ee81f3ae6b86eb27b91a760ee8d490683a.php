...
<div class="container">
			...
			<div class="product-detail-infomation col-md-7 col-xs-4">
				...
				<div class="product-detail-star">
					...
					<?php if(isset($Point)){
						...
						<img data-product="<?php echo $itemProduct->id; ?>" data-point='<?php echo $iPoint ?>' src="<?php echo url('public/images'); ?>/<?php echo $iPoint<=$Point ? 'star-on.png' : 'star-off.png' ?>" alt="<?php echo $iPoint ?>">
						<?php
					}
				} ?>
			</div>
	...
	<div class="product-detail-comment col-xs-12">
		...
		<div class="cmt-container">
			<div class="fb-comments" data-href="<?php echo url('');; ?>/product?id=<?php echo $itemProduct->id; ?>" data-width="100%" data-numposts="5" data-order-by="reverse_time"></div>
		</div>
		<!-- end start all cmt -->
	</div>
	<!-- end comment -->

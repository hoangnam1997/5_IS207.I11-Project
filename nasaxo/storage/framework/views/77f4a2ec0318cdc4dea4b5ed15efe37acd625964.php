...
<?php if(isset($listProduct)){ ?>
	<?php foreach ($listProduct as $key => $value): ?>
	{
		"data":{
			...
			'Picture':'<?php foreach ($listPicture as $key => $valuePicture): ?><img class="img-product" src="<?php echo url("public/images/"); ?>/<?php echo $valuePicture->Url; ?>"><?php endforeach ?>',
...
<script type="text/javascript" src="<?php echo url('public/js/ManageProduct/_search.js'); ?>"></script>

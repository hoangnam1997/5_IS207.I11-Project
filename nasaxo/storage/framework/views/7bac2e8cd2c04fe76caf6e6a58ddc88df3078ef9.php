...
<script type="text/javascript">
    	...
    	foreach ($listColor as $key => $value) { ?>
    		{
    			"data":{
    				...
    				"Action":"<i data-edit='<?php echo $value->id; ?>' class='editColor fa fa-pencil-square-o fa-2x' aria-hidden='true'></i><i data-delete='<?php echo $value->id; ?>' class='deleteItem fa fa-trash-o fa-2x' aria-hidden='true'></i>"
    			},
    			"flag":0
    		},
    		<?php }
    ...
    <script type="text/javascript" src="<?php echo url('public/js/ManageColor/_search.js'); ?>"></script>

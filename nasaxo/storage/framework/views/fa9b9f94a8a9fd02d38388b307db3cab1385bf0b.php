...
<!-- my custom -->
<link rel="stylesheet" type="text/css" href="<?php echo url('public/css/ManageAddress/index.css'); ?>">
<!-- Modal -->
...
<!-- end container -->
<!-- script custom js -->
<script type="text/javascript" src="<?php echo url('public/js/ManageAddress/district/index.js'); ?>"></script>

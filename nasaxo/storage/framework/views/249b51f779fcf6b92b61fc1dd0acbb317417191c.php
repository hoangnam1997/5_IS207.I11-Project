...
<!-- my custom -->
<link rel="stylesheet" type="text/css" href="<?php echo url('public/css/ManageSize/index.css'); ?>">
<!-- Modal -->
				...
				<div class="form-inline col-md-12">
					<div class="form-group pull-left col-md-12">
						<div class="input-group">
							<input id="inputSizeSearch" type="text" class="form-control">
...
<!-- end container -->
<!-- script custom js -->
<script type="text/javascript" src="<?php echo url('public/js/ManageSize/index.js'); ?>"></script>

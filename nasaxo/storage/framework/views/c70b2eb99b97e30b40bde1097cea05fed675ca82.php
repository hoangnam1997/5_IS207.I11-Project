	...
	<table class="Table-Pagin table table-hover table-striped table-bordered">
		<thead>
			<tr>
				...
				<th class="table-Sort" data-sort="Size" style="width: 25%;">Phường xã</th>
...
<script type="text/javascript">
    	...
    	foreach ($listWard as $key => $value) { ?>
    		{
    			"data":{
    				...
    				"nameDistrict":"<?php echo $value['nameDistrict']; ?>",
    				"idDistrict":"<?php echo $value['idDistrict']; ?>",
    ...
    <script type="text/javascript" src="<?php echo url('public/js/ManageAddress/ward/_search.js'); ?>"></script>

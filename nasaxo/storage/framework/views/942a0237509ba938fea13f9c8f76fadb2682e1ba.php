<?php if(isset($user)){ ?>
<link rel="stylesheet" type="text/css" href="<?php echo url('public/css/Account/information.css'); ?>">
<form enctype="multipart/form-data" id="upload_form" method="POST" action="" class="row">
	...
	<div class="imageUser col-xs-2">
		...
		<img title="Click để thay đổi hình ảnh" class="input-Img" id="imgUser" src="<?php echo url('public/images'); ?>/<?php echo isset($image[0])? $image[0]->Url : "default.jpg"; ?>">
...
<script type="text/javascript" src="<?php echo url('public/js/Account/InfomationAccount.js'); ?>"></script>
<?php } ?>
<!-- end content -->
<!-- end container -->
<!-- custom js -->

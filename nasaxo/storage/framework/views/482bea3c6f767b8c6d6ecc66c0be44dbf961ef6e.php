<div class="row">
	<div class="col-md-12 headerTable" style="margin-top:35px;">
		<img style="width: 20px;height: 20px;cursor: pointer;" id="changeStyle" src="<?php echo url('public/images'); ?>/Refresh_icon.png" class="pull-left" />
	</div>
	<canvas id="statistic-Chart"></canvas>
</div>

<script type="text/javascript" src="<?php echo url('public/js/Chart.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo url('public/js/ManageHome/mychart.js'); ?>"></script>
<script>

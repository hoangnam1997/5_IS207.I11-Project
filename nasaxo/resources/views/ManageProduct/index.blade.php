...
<script type="text/javascript">
    ...
    var listDataTable = [{
    	"data":{
    		"STT":"1",
    		"Picture":'<img class="img-product" src="{!! url("public/images/11.jpg") !!}">',
    		"Name":"sản phẩm 1",
    	...
    	"data":{
    		"STT":"2",
    		"Picture":'<img class="img-product" src="{!! url("public/images/11.jpg") !!}"><img class="img-product" src="{!! url("public/images/11.jpg") !!}"><img class="img-product" src="{!! url("public/images/11.jpg") !!}"><img class="img-product" src="{!! url("public/images/11.jpg") !!}">',
    		"Name":"Sản phẩm 2",
    		"ProductCategory":"Nhóm sản phẩm",
    		"Price":"20.000",
    		"Description":"Mô tả",
    	...
    	"data":{
    		"STT":"5",
    		"Picture":'<img class="img-product" src="{!! url("public/images/11.jpg") !!}"> <img class="img-product" src="{!! url("public/images/11.jpg") !!}">',
    		"Name":"Sản phẩm 5",
    		"ProductCategory":"Nhóm sản phẩm",
    		"Price":"20.000",
    		"Description":"Mô tả",
